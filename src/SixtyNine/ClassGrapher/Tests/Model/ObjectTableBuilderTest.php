...
class ObjectTableBuilderTest extends \PHPUnit_Framework_TestCase
{
    public function testBuild()
    {
        ...
        $this->assertInstanceOf('SixtyNine\\ClassGrapher\\Model\\InterfaceItem', $item);
        ...
        $this->assertInstanceOf('SixtyNine\\ClassGrapher\\Model\\ClassItem', $item);
        $this->assertEquals($ns . 'MyClass1', $item->getName());
        $this->assertEquals(array('SixtyNine\\ClassGrapher\\Graph\\GraphViz'), $item->getExtends());
