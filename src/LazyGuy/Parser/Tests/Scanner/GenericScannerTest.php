...
use LazyGuy\Parser\Scanner\GenericScanner,
    LazyGuy\Parser\Reader\FileReader,
    LazyGuy\Parser\Scanner\GenericToken as Token,
    LazyGuy\Parser\Scanner\TokenQueue,
    LazyGuy\Parser\Scanner\TokenFilter;
...
class GenericScannerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testFilteredScan()
    {
        ...
        // Test the raw file with newlines and whitespaces
        $scanner = new GenericScanner();
        $scanner->addTokenFilter(new TokenFilter\NoNewlinesFilter());
        $scanner->addTokenFilter(new TokenFilter\NoWhitespacesFilter());
